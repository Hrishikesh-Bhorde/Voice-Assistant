...
def repeath():
                ...
                if the_command == "open google":
                   ...
                   repeath()
                    ...
                    s.starttls()
                    s.login("yourgmail@gmail.com", "yourpassword")
                    s.sendmail("yourgmail@gmail.com", Send_email, Mess_age)
                    s.quit()
                    repeath()
                elif the_command == "who is the creater of you":
                    speak("I am created by Hrishikesh Bhorde")
                    print("I am created by Hrishikesh Bhorde")
                    print("You can contact him by E-mail : hrishikeshbhorde7@gmail.com")
